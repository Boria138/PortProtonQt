...
### Added
- Добавлены анимированные и статические фоны детальной страницы `aurora`, `diagnostics`, `metaballs`, `sakura` и `veins`, вдохновлённые проектом omikuji
...
- Добавлен ручной выбор аккаунта Steam в настройках с автоматическим выбором по умолчанию
