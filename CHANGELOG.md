...
- На вкладке «Настройки Wine» добавлена кнопка установки Wine по умолчанию
...
- Исправлено соответствие лицевых кнопок Xbox и PlayStation в подсказках и действиях геймпада (`X -> Квадрат`, `Y -> Треугольник`)
