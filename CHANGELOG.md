...
- Исправлены предупреждения EGL на NVIDIA с отключённым контейнером
- Исправлено ложное определение установленных автоустановок с одинаковыми именами лаунчеров
