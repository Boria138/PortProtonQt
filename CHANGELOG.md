...
- pyproject теперь используется исключительно как менеджер зависимостей для UV сборка через него более невозможна
- Скриншоты в metainfo теперь размера 1000x700 для соответствия стандартом Flathub
