...
- Добавлен тип отображения времени `Steam` с часами, десятичными минутами и без учёта секунд
...
- Исправлено применение текущего типа отображения времени к проведённому времени на детальной странице
