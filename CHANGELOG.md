...
- Добавлена анимация появления виртуальной клавиатуры
...
- Аргумент командной строки `--silent` для запуска мгновенного запуска `exe` без интерфейса
...
- При запуске игры теперь отображаются загрузка и распаковка Libs и Plugins
