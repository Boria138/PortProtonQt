...
- Возвращена настройка типа геймпада для подсказок: Авто, Xbox или PlayStation
...
- Исправлено определение установленных автоустановок по `.desktop` и возврат к исходной карточке
...
- Исправлено редактирование имени папки в файловом менеджере: `Backspace` больше не поднимает на папку выше при вводе текста
