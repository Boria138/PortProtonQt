...
- [ ] Исправить склонения в детальном выборе времени, например не 3 часов назад, а 3 часа назад
- [ ] Добавить перевод через gettext
- [ ] Добавить недокументированные параметры конфигурации в GUI (time detail_level)
